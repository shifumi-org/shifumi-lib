                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                <div id="arm_year_filter_item" class="arm_filter_status_box arm_datatable_filter_item">
                                    ...
                                    <dl class="arm_selectbox">
                                        <dt class="arm_width_100"><span><?php echo $year; ?></span><input type="text" style="display:none;" value="" class="arm_autocomplete"><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                        <dd>
