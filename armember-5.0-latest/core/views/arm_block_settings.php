                                        ...
                                        <table class="arm-form-table-login-security">
                                            ...
                                            <tr>
                                                ...
                                                <td class="arm_width_500">
                                                    <select id="arm_reset_login_attempts_users arm_width_352" class="arm_chosen_selectbox" name="arm_general_settings[arm_exclude_role_for_restrict_admin][]" data-placeholder="<?php _e('Select User(s)..', 'ARMember');?>" multiple="multiple"  >
                                                        <?php
