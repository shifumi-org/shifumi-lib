					...
					<table class="form-table">
						...
						<tr class="form-field">
							...
							<td class="arm-form-table-content arm_import_export_date_fields">
								...
								<input type="text" name="end_date" placeholder="<?php _e('End Date', 'ARMember');?>" id="arm_admin_import_export_end_date" class="arm_admin_import_export_datepicker" data-date_format="<?php echo $arm_common_date_format; ?>">
							</td>
						</tr>
                        <tr class="form-field">
						...
						<tr class="form-field">
							...
							<td class="arm-form-table-content">
								...
								<button id="arm_user_export_btn_xml" class="armemailaddbtn arm_min_width_120" name="arm_action" value="user_export_xml" type="submit" ><?php _e('Export as xml', 'ARMember');?></button>
