<?php
/**
 * Handles all server side logic for the ld-user-status Gutenberg Block. This block is functionally the same
 * as the ld_user_status shortcode used within LearnDash.
 *
 * @package LearnDash
 * @since 4.0
 */
...
if ( ( class_exists( 'LearnDash_Gutenberg_Block' ) ) && ( ! class_exists( 'LearnDash_Gutenberg_Block_User_Status' ) ) ) {
	/**
	 * Class for handling LearnDash Infobar Block
	 */
	class LearnDash_Gutenberg_Block_User_Status extends LearnDash_Gutenberg_Block {

		/**
		 * Object constructor
		 */
		public function __construct() {
			$this->shortcode_slug   = 'learndash_user_status';
			$this->block_slug       = 'ld-user-status';
...
new LearnDash_Gutenberg_Block_User_Status();
