...
$is_paid_post = 1;
?>
<div class="wrap arm_page arm_view_member_main_wrapper">
            ...
            <form class="arm_member_detail_wrapper_frm arm_admin_form">
				...
				<div class="page_sub_content arm_member_details_container">
											...
											if (!empty($user->$meta_key)) {
												if ($field_options['type'] == 'file') {
                                                    ...
                                                    if ($user->$meta_key != '') {
														...
														?><a href="<?php echo $user->$meta_key;?>" target="__blank"> <img src="<?php echo $thumbUrl;?>" style="max-width: 100px;height: auto;"></a><?php
                                                    } 
					...
					<div class="arm_view_member_right_box">
						...
						<?php
							if($arm_social_feature->isSocialFeature) { ?>
								<button type="button" class="armemailaddbtn arm_view_membership_card_btn" data-id="<?php echo $user_id; ?>"><?php esc_html_e('View Membership Card', 'ARMember'); ?></button>
						<?php	}
						?>
					...
					<?php
						$arm_member_details = "";
						$arm_member_details = apply_filters('arm_view_member_details_outside', $arm_member_details, $user_id);
					?>	
