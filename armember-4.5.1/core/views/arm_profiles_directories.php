...
$fonts_option = array('title_font'=>array('font_family'=>'Helvetica','font_size'=>'14','font_bold'=>'0','font_italic'=>'0','font_decoration'=>'',),'subtitle_font'=>array('font_family'=>'Helvetica','font_size'=>'14','font_bold'=>'0','font_italic'=>'0','font_decoration'=>'',),'button_font'=>array('font_family'=>'Helvetica','font_size'=>'14','font_bold'=>'0','font_italic'=>'0','font_decoration'=>'',),'content_font'=>array('font_family'=>'Helvetica','font_size'=>'16','font_bold'=>'0','font_italic'=>'0','font_decoration'=>'',));
                        ...
                        <div class="arm_template_option_block">
                            <div class="arm_directory_template_name_div arm_form_fields_wrapper">
                                ...
                                <div class="arm_opt_content">
                                    <input type="text" name="arm_directory_template_name" class="arm_form_input_box" value="<?php echo $arm_directory_template_name; ?>">
                                </div>
                            </div>
						...
						<div class="arm_template_option_block">
							...
							<div class="arm_opt_content">
                                ...
                                <div class="arm_temp_opt_box arm_temp_directory_options">
									...
									<div class="arm_opt_content_wrapper">
                                        <input id="arm_temp_per_page_users" type="text" onkeydown="javascript:return checkNumber(event)" value="<?php echo $per_page_users; ?>" style="width:70px;" name="template_options[per_page_users]">
                                    </div>
                                </div>
                                <div class="arm_temp_opt_box arm_temp_directory_options">
								...
								<div class="arm_temp_opt_box">
									...
									<div class="arm_opt_content_wrapper">
										<div class="arm_custom_css_wrapper">
											<textarea class="arm_codemirror_field" name="template_options[custom_css]" cols="10" rows="6" style="width: 500px;"><?php echo $custom_css; ?></textarea>
										</div>
										<div class="armclear"></div>
