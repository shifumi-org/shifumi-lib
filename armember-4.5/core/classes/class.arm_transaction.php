...
if (!class_exists('ARM_transaction'))
{
	class ARM_transaction
	{
				...
				<div class="arm_invoice_detail_popup popup_wrapper arm_invoice_detail_popup_wrapper" style="width:800px;">
					<div class="popup_wrapper_inner" style="overflow: hidden;">
						...
						<div class="popup_content_text arm_invoice_detail_popup_text" id="arm_invoice_detail_popup_text" style="padding: 0;">
							...
							<iframe src="<?php echo ARM_HOME_URL."/?log_id=".$log_id."&log_type=".$log_type."&is_display_invoice=1" ; ?>" id="arm_invoice_iframe" style="width: 100%;height:665px;"></iframe>
						</div>
		...
		function arm_bulk_delete_transactions()
		{
			...
			if(empty($ids) && empty($btids) && empty($ppids))
			{
		...
		{
			global $wp, $wpdb, $current_user, $arm_errors, $ARMember, $arm_global_settings, $arm_subscription_plans,$arm_manage_coupons, $arm_debug_payment_log_id;
