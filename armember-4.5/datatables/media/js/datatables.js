 ...
 *   https://datatables.net/download/#dt/dt-1.10.21/b-1.6.2/cr-1.5.2/fc-3.3.1/fh-3.1.7/r-2.2.5
 *
 * Included libraries:
 *   DataTables 1.10.21, Buttons 1.6.2, ColReorder 1.5.2, FixedColumns 3.3.1, FixedHeader 3.1.7, Responsive 2.2.5
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.21/b-1.6.2/cr-1.5.2/fc-3.3.1/fh-3.1.7/r-2.2.5",
...
$.extend( Buttons.prototype, {
	...
	_popover: function ( content, hostButton, inOpts ) {
		...
		var display = $('<div/>')
			.addClass('dt-button-collection ColVis_collection TableTools_collection ui-buttonset ui-buttonset-multi')
	...
	collection: {
		...
		action: function ( e, dt, button, config ) {
			...
			if ( config._collection.parents('body').length ) {
				...
				jQuery(config._collection).find('button.ColVis_Button.active').each(function(){
