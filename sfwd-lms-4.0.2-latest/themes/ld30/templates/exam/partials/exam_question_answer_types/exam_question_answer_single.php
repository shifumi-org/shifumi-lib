...
$learndash_answer_content .= '<input type="radio" id="ld-exam-question-answer-' . $learndash_question_model->question_idx . '-' . $learndash_question_answer['answer_idx'] . '" name="ld-exam-question-answer[' . $learndash_question_model->question_idx . ']" value="' . $learndash_question_answer['answer_idx'] . '" ' . $learndash_input_checked . ' ' . $learndash_input_disabled . '/>';
