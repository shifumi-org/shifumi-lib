	...
	<body <?php body_class(); ?>>
		...
		<div class="<?php echo esc_attr( learndash_the_wrapper_class() ); ?>">
			<?php
				 ...
				 */
			?>
			<div class="ld-focus ld-focus-initial-transition <?php echo esc_attr( apply_filters( 'learndash_focus_mode_collapse_sidebar', false ) ? 'ld-focus-sidebar-collapsed ld-focus-sidebar-filtered' : '' ); ?>">
				<?php
				/**
