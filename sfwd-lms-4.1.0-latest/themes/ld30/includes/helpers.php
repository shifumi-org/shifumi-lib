...
function learndash_get_course_price( $course = null, ?int $user_id = null ): array {
	...
	if ( ! empty( $course_price['price'] ) ) {
		$course_price['price'] = preg_replace( '/[^0-9.]/', '', $course_price['price'] );
	}

	if ( ! empty( $course_price['trial_price'] ) ) {
		$course_price['trial_price'] = preg_replace( '/[^0-9.]/', '', $course_price['trial_price'] );
	}
...
function learndash_get_group_price( $group = null, ?int $user_id = null ): array {
	...
	if ( ! empty( $group_price['price'] ) ) {
		$group_price['price'] = preg_replace( '/[^0-9.]/', '', $group_price['price'] );
	}

	if ( ! empty( $group_price['trial_price'] ) ) {
		$group_price['trial_price'] = preg_replace( '/[^0-9.]/', '', $group_price['trial_price'] );
	}
