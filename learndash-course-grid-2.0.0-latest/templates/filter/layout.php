        ...
        <?php if ( $atts['price'] == true ) : ?>
            <div class="filter price">
                ...
                <div class="number-wrapper left">
                    <label for="price_min-<?php echo esc_attr( $atts['course_grid_id'] ); ?>"><?php _e( 'Min', 'learndash-course-grid' ); ?></label>
                ...
                <div class="number-wrapper right">
                    <label for="price_max-<?php echo esc_attr( $atts['course_grid_id'] ); ?>"><?php _e( 'Max', 'learndash-course-grid' ); ?></label>
