	...
	if ( isset( $_GET['ld_register_id'] ) && '0' < $_GET['ld_register_id'] ) :
		...
		<div class="order-overview">
			...
			<div class="purchase-rows">
				<?php if ( 'subscribe' === $course_pricing['type'] && ! empty( $course_pricing['trial_price'] ) ) : ?>
					<div class="purchase-row">
						...
						<span class="purchase-field-price">
							<?php echo esc_html( learndash_get_price_formatted( $course_pricing['trial_price'] ) ); ?>

							<?php if ( ! empty( $course_pricing['trial_interval'] ) ) : ?>
					...
					<span class="purchase-value">
						...
						if ( ! empty( $course_pricing['interval'] ) ) {
							...
							if ( ! empty( $course_pricing['repeats'] ) ) {
								echo esc_html__( ' for ', 'learndash' ) . absint( $course_pricing['repeats'] ) . ' ' . esc_html( $course_pricing['repeat_frequency'] );
							}
						}
						?>
					</span>
