	...
	<div class="page_sub_content">
		<form method="post" action="#" id="arm_api_security_key_form" class="arm_api_security_key_form arm_admin_form" onsubmit="return false;">
			...
			<table class="form-table">
				<tbody>
					<tr class="form-field">
						...
						<td>
							<input id="arm_api_security_key" type="text" name="arm_general_settings[arm_api_security_key]" value="<?php echo $arm_api_key; ?>" data-old_value="<?php echo $arm_api_key; ?>">
			...
			<div class="arm_submit_btn_container">
				<button id="arm_api_service_feature_btn" class="arm_save_btn" name="arm_api_service_feature_btn" type="submit"><?php _e('Save', 'ARMember') ?></button>&nbsp;<img src="<?php echo MEMBERSHIP_IMAGES_URL.'/arm_loader.gif' ?>" id="arm_loader_img" style="position:relative;top:8px;display:none;" width="24" height="24" />
			</div>
