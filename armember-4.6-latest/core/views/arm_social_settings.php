				...
				<div class="arm_sub_section">
                    ...
                    <table class="form-table">
                        ...
                        <tr class="form-field">
                            <th class="arm-form-table-label"><label><?php _e('Callback URL', 'ARMember'); ?></label></th>
                            <td class="arm-form-table-content">
                                <span class="arm_info_text"><?php echo ARM_HOME_URL; ?>/</span><br><span style="font-size:13px;"><em><?php _e('Callback URLs that you should add in Tumblr Application -> Settings.', 'ARMember'); ?></em></span>
                            </td>
                        </tr>
                    </table>
                    <!-- Tumblr module over -->
