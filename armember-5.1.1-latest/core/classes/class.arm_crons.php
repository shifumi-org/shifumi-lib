                        ...
                        foreach($plan_ids as $plan_id)
                        {
                            ...
                            if(!empty($planData))
                            {
                                ...
                                if ($plan->is_recurring() && $payment_mode == 'manual_subscription') 
                                {
                                    ...
                                    $arm_is_user_in_grace = isset($planData['arm_is_user_in_grace']) ? $planData['arm_is_user_in_grace'] : 0;
                                    $arm_grace_period_end = isset($planData['arm_grace_period_end']) ? $planData['arm_grace_period_end'] : '';
                                    ...
                                    if($recurring_time != $completed || 'infinite'==$recurring_time)
                                    {
                                        if (!empty($expireTime)) 
                                        {
                                            ...
                                            if ($arm_next_due_date <= $end_time || ($arm_is_user_in_grace==1 && !empty($arm_grace_period_end) && $arm_grace_period_end <= $end_time) ) 
                                            {
                                ...
                                if ($payment_mode == 'auto_debit_subscription') {
                                    ...
                                    if($recurring_time != $completed || 'infinite'==$recurring_time){
                                        ...
                                        if(!empty($actual_arm_next_due_date)){
                                            ...
                                            if($now > $arm_next_due_date || ($arm_is_user_in_grace==1 && !empty($arm_grace_period_end) && $now > $arm_grace_period_end ) ){
