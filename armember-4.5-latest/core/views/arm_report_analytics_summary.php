                        ...
                        <div class="sltstandard" style=" <?php echo $float; ?>">
                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                <div id="arm_date_filter_item" class="arm_filter_status_box arm_import_export_date_fields">
                                    <input type="text" id="arm_date_filter" placeholder="Select date" class="arm_datepicker_filter" value="">
                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                <div id="arm_month_filter_item" class="arm_filter_status_box arm_datatable_filter_item">
                                    ...
                                    <dl class="arm_selectbox">
                                        <dt style="width: 100px;"><span><?php echo $month_label; ?></span><input type="text" style="display:none;" value="" class="arm_autocomplete"><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                        <dd>
                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                <div id="arm_plan_filter_item" class="arm_filter_status_box arm_datatable_filter_item">
                                    ...
                                    <dl class="arm_selectbox">
                                        <dt style="width: 150px;"><span><?php esc_html_e('All Plans', 'ARMember'); ?></span><input type="text" style="display:none;" value="" class="arm_autocomplete"><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                        <dd>
                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                ...
                                <input type="button" class="armemailaddbtn" id="arm_report_export_button" value="<?php esc_html_e('Export to CSV','ARMember'); ?>">
            ...
            <div class="arm_members_table_container">
                <div class="arm_all_loginhistory_wrapper">
                    <table class="form-table arm_member_last_subscriptions_table" width="100%">
                        <thead>
                            <tr>
                                <td><?php esc_html_e('Username', 'ARMember'); ?></td>
                        ...
                        <div class="sltstandard" style=" <?php echo $float; ?>">
                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                <div id="arm_plan_filter_item" class="arm_filter_status_box arm_datatable_filter_item">
                                    <input type="hidden" id="arm_plan_filter" class="arm_plan_filter" value="">
                                    <dl class="arm_selectbox">
                                        <dt style="width: 120px;"><span><?php esc_html_e('All Plans', 'ARMember'); ?></span><input type="text" style="display:none;" value="" class="arm_autocomplete"><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                        <dd>
                                            <ul data-id="arm_plan_filter" data-placeholder="Select Status">
                                                <?php echo $plansLists; ?>
                                            </ul>
                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                <div id="arm_gateway_filter_item" class="arm_filter_status_box arm_datatable_filter_item">
                                    ...
                                    <dl class="arm_selectbox">
                                        <dt style="width: 110px;"><span><?php esc_html_e('All Gateways', 'ARMember'); ?></span><input type="text" style="display:none;" value="" class="arm_autocomplete"><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                        <dd>
                    ...
                    <table class="form-table arm_member_last_subscriptions_table" width="100%">
                        <thead>
                            <tr>
                                ...
                                <td><?php esc_html_e('Amount', 'ARMember'); ?></td>
                        ...
                        <div class="sltstandard" style=" <?php echo $float; ?>">
                            ...
                            <div style=" <?php echo $float; ?>" class="arm_filter_div">
                                <div id="arm_gateway_filter_item" class="arm_filter_status_box arm_datatable_filter_item">
                                    <input type="hidden" id="arm_gateway_filter" class="arm_gateway_filter" value="">
                                    <dl class="arm_selectbox">
                                        <dt style="width: 130px;"><span><?php esc_html_e('All Gateways', 'ARMember'); ?></span><input type="text" style="display:none;" value="" class="arm_autocomplete"><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                        <dd>
                                            <ul data-id="arm_gateway_filter" data-placeholder="Select Status">
                                                <?php echo $gateways_list; ?>
                                                <?php ?>
