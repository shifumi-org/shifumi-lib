            ...
            <tr class="form-field">
                ...
                <tr class="form-field">
                    ...
                    <td class="arm-form-table-content">
                        ...
                        <br>
                          <span id="license_link"><button type="button" id="renew-user-badge" name="renew_user_badge" style="width:200px; border:0px; color:#FFFFFF; height:40px; border-radius:3px; box-shadow:0 4px 0 0 #459765;" class="greensavebtn"><?php _e('Refresh License', 'ARMember'); ?></button></span>
